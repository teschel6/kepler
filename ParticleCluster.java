...
public class ParticleCluster {
	...
	public static ArrayList<Particle> randomDistribution
		(double x,double y, double radius, int N, double mass){
	...
	public static ArrayList<Particle> discGalaxy
		(double x, double y, double radius, int N, double mass){
	...
	public static ArrayList<Particle> gaussianDistribution
		(double x, double y, double radius, int N, double mass){
